...
# --- MAPEAMENTO POR POSIÇÃO (Mais seguro contra mudanças de nome) ---
df_base = df_raw.copy()
...
# Tratamento de Setores (Separa casos com vírgula)
...
if not df_sim.empty:
    ...
    st.subheader(f"Principais Queixas - {setor_sel}")
    ...
    with st.expander("Ver Detalhamento Nominal"):

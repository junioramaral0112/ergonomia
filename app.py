...
# -----------------------------------------------------------
# IDENTIFICAÇÃO DINÂMICA DE COLUNAS (AJUSTADO)
# -----------------------------------------------------------
colunas = df_original.columns.tolist()

# Busca por colunas que contenham as palavras-chave, ignorando maiúsculas/minúsculas e símbolos
...
with c2:
    # Captura os setores únicos da coluna identificada
    if coluna_setor:
...
# Coordenadas Ajustadas para o seu Mapa
coords = {
    "Braços / Mãos": [250, 350], 
...
with col_map:
    try:
        ...
        fig.update_traces(textfont=dict(size=14, family="Arial Black", color="black"), textposition='middle center')
